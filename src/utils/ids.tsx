...
export type StringPublicKey = string;
 ...
 export const STAKE_VAULT_PUBKEY =   toPublicKey("7KYUVqDN2XQuh8o7VYCfjRVMqYdEfKomZyB1uUT6P2em");
 export const STAKE_CONFIG_PUBKEY =  toPublicKey("3j5piHzGxMBUrZh3YVKzi66hiBnWdpGswwKrX5oh6qiP");
